...
- **Flip-to-Heff (2)** - [85746](https://passist.org/siteswap/85746?jugglers=2) - **???**
...
- **Not likely** - [96672](https://passist.org/siteswap/96672?jugglers=2) - has a stack
  - J1: (1|2, (d => X), d313p)
  - J2: (1|2, (p => X), 3pd31)
- **Flip-to-Heff** - [78456](https://passist.org/siteswap/78456?jugglers=2) - has stack
...
- 10 clubs 2-count - [b9](https://passist.org/siteswap/b9?jugglers=3&hands=Ar-Bl-Cr-Al-Br-Cl)

### 11 clubs {-}

- 11 clubs 2-count - [d9](https://passist.org/siteswap/d9?jugglers=3&hands=Ar-Bl-Cr-Al-Br-Cl)
  - 13 club version is [h9](https://passist.org/siteswap/h9?jugglers=3&hands=Ar-Bl-Cr-Al-Br-Cl)!
...
- **Shooting star (4 people, 9 clubs, 4-count)**
...
- **Shooting star (4 people, 11 clubs, 4-count)**
  - Same as above, but faster
  - B has 2 clubs now
  - A starts the run immediately after the first pass, then C moves (after 1 4-count), then E (after 2 4-counts), then B (after 3 4-counts)
...
- **Star (5 people)**
  ...
  - 1,2,3,4-count works!
- **3-count Feast (Boston circle, 5 people)**
  - Pass to everyone in turn, including yourself! All passes start right-handed, then become left-handed, etc.
  - Hand-feast (nice variation, feels like Jim's)
  - In principle, this pattern can be done with more people and different counts as well!
