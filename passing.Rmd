...
- 645
- 852 (heff, zip, zap)
- [825](https://passist.org/siteswap/852?jugglers=2) (heff, zap, zip)
- [55258](https://passist.org/siteswap/55258?jugglers=2)
  - With Christian at Swedish passout
...
- [972](https://passist.org/siteswap/972?jugglers=2) (weird start!)
  - 2|1 (you don't do the first zip!) vs 1|2: (dp)1p (x,||) vs p(dp)1 (x,||)
  - (dp) => double pass
  - Pattern feels like two passes - p(dp) - that both end up **on the same hand**
  - First person that starts with 2 clubs on his/her left hand, sends a crossing double, waits a bit and then sends the above pattern starting with left.
...
- Not likely => [72966](https://passist.org/siteswap/72966?jugglers=2)
  - Need good separation of single and double pass!
...
- **6-club why-not feedees 2 x 7-club 5-count popcorns**  
